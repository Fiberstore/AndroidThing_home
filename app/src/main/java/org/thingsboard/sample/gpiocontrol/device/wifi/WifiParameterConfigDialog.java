package org.thingsboard.sample.gpiocontrol.device.wifi;
...
import org.thingsboard.sample.gpiocontrol.constant.Constant;
import org.thingsboard.sample.gpiocontrol.util.SharedPreferencesUtil;

import static org.thingsboard.sample.gpiocontrol.constant.Constant.MESSAGE_UPDATE_PARAMETER;
...
public class WifiParameterConfigDialog {
    ...
    public void show() {
        ...
        final EditText etWifiIpConfig = contentView.findViewById(R.id.et_wifi_ip);
        final EditText etWifiPortConfig = contentView.findViewById(R.id.et_wifi_port);
