package org.thingsboard.sample.gpiocontrol.device.serial;
...
public class SerialPortList extends Activity {
    ...
    private void initView() {
        //串口路径初始化
        spSerialPortPath = findViewById(R.id.sp_serialport_path);
        ArrayAdapter arrayAdapter;
        if (entries != null) {
            arrayAdapter = new ArrayAdapter(this, R.layout.sp_tv_item, entries);
        } else {
            arrayAdapter = new ArrayAdapter(this, R.layout.sp_tv_item, new String[]{"该设备不支持串口"});
        }
