package com.thingsboard.home.device.wifi;
...
import com.thingsboard.home.constant.Constant;


import com.thingsboard.home.util.SharedPreferencesUtil;
                ...
                .setNegativeButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (!TextUtils.isEmpty(strIp) && !TextUtils.isEmpty(strPort)) {
                            ...
                            message.what = Constant.MESSAGE_UPDATE_PARAMETER;
