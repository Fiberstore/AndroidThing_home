...
import com.thingsboard.home.adapter.MqttInfoAdapter;
...
import com.thingsboard.home.util.WriteReadADBShell;
...
public class ConnectMqttActivity extends BaseActivity {
    ...
    public void gettemp() {
        scheduledExecutorService = timedTask(1, new Runnable() {
            @Override
            public void run() {
